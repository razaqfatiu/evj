...
// Function to get charge station by itts ID
...
async function chargestations() {
  try {
    ...
    for (i in response.data.ChargeDevice) {
      ...
      //   var ConnectorRatedOutputkW =
      //     response.data.ChargeDevice[i].Connector[i].RatedOutputkW;
      ...
      distance.push({
        ...
        // ConnectorRatedOutputkW: ConnectorRatedOutputkW,
        // AvailableConnectors: numberOfConnectors,
      });
    }
